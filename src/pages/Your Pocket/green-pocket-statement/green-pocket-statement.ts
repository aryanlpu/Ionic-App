...
@Component({
  selector: 'page-green-pocket-statement',
  templateUrl: 'green-pocket-statement.html',
	  providers: [PocketProvider]
})
export class GreenPocketStatementPage {
	public detail:any;
	...
	dismiss() {
	  ...
	  getdata() {
		...
		this.loader.present();
		  this.PocketProvider.getGreenPocketSummary()
		  .then(data => {
